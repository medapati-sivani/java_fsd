...
/**
 * Servlet implementation class ViewTrainerandSubjects
 */
public class ViewTrainerandSubjects extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewTrainerandSubjects() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("ViewTrainerAndSubjects.jsp");
	}
